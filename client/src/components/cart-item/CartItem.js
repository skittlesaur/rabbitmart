    ...
    return (
        <div className={styles['wrapper']}>
            ...
            <div className={styles['info']}>
                ...
                <div className={styles['weight']}>{parseFloat(product.weight) * parseFloat(product.quantity || '1')}{product.measurement}</div>
            ...
            <div className={styles['price']}>
                <div className={styles['total-price']}>{parseFloat(product.price) * parseFloat(product.quantity || '1')} EGP</div>
